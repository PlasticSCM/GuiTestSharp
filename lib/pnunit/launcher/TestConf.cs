...
namespace PNUnit.Launcher
{
    ...
    public class TestGroup
    {
        ...
        public List<ParallelTest> ParallelTests;
    }
    ...
    public class TestConfLoader
    {
        ...
        private static void ReplaceVariables(IList<ParallelTest> target, Variable[] variables)
        {
        ...
        static readonly log4net.ILog mLog = log4net.LogManager.GetLogger("launcher");
    }
